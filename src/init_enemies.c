...
static bool	init_anim_enemy_red(t_character *e, mlx_t *mlx)
{
...
static bool	init_anim_enemy_blue(t_character *e, mlx_t *mlx)
{
...
static bool	init_anim_enemy_orange(t_character *e, mlx_t *mlx)
{
...
static bool	init_anim_enemy_pink(t_character *e, mlx_t *mlx)
{
